...
public class LessonBatchNew implements Serializable {
	private static final long serialVersionUID = -4401280057132164021L;
	...
	public String toString() {
		return "LessonBatchNew [lessonid=" + lessonid + ", lessonname=" + lessonname + ", lessontype=" + lessontype
				...
				+ ", lessonjc=" + lessonjc + ", xnxqh=" + xnxqh + ", kssj=" + kssj + ", jssj=" + jssj + "]";
	}
